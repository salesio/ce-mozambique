...
const translations = {
  pt: {
    ...
    "of.emola": "E-Mola",
    "of.bank": "Banco",
    "of.confirm.btn": "Confirmar Oferta / Dízimo / Parceria",
    "of.confirm.cta": "Depois de transferir, confirme aqui para que a equipa de Finanças possa verificar o seu relatório.",
    "giving.eyebrow": "Confirmação",
    "giving.title": "Relatório de Doação, Dízimo e Parceria",
    "giving.section.personal": "Dados Pessoais",
    "giving.section.contributions": "Contribuições",
    "giving.section.payment": "Pagamento / Comprovativo",
    "giving.field.fullName": "Nome completo",
    "giving.field.birthday": "Data de aniversário",
    "giving.field.phone": "Telefone",
    "giving.field.email": "E-mail",
    "giving.field.church": "Igreja",
    "giving.field.churchPlaceholder": "Seleccione a igreja",
    "giving.field.cellGroup": "Grupo de célula",
    "giving.field.cell": "Célula",
    "giving.field.cellGroupPlaceholder": "Seleccione o grupo de célula",
    "giving.field.cellPlaceholder": "Seleccione a célula",
    "giving.field.noCells": "Nenhuma célula registada neste grupo.",
    "giving.field.otherDesc": "Especifique as categorias e montantes das outras doações",
    "giving.field.paymentMethod": "Método de pagamento",
    "giving.field.methodPlaceholder": "Seleccione",
    "giving.field.reference": "Referência da transacção",
    "giving.field.transferDate": "Data da transferência",
    "giving.field.pop": "Anexar comprovativo / POP",
    "giving.field.fileHint": "JPG, PNG, WEBP ou PDF — máx. 5 MB",
    "giving.field.transferMessage": "Colar mensagem da transferência M-Pesa / E-Mola / Conta móvel",
    "giving.field.notes": "Observações",
    "giving.total": "Total Geral",
    "giving.cancel": "Cancelar",
    "giving.submit": "Submeter Relatório",
    "giving.success": "Obrigado. O seu relatório foi submetido com sucesso e ficará pendente de verificação pela equipa de Finanças.",
    "giving.error.name": "Indique o nome completo.",
    "giving.error.phone": "Indique o telefone.",
    "giving.error.church": "Seleccione a igreja.",
    "giving.error.amount": "Indique pelo menos um montante maior que zero.",
    "giving.error.method": "Seleccione o método de pagamento.",
    "giving.error.date": "Indique a data da transferência.",
    "giving.error.proof": "Anexe o comprovativo ou cole a mensagem da transferência.",
    "giving.error.fileType": "Tipo de ficheiro não permitido. Use imagem ou PDF.",
    "giving.error.fileSize": "O ficheiro é demasiado grande. Máximo 5 MB.",
    "giving.error.otherDesc": "Descreva as outras doações quando o montante de Outros for maior que zero.",
    "giving.error.spam": "Não foi possível submeter o formulário.",
    "giving.error.generic": "Ocorreu um erro ao submeter. Tente novamente.",
    "giving.cat.tithe": "Dízimo",
    "giving.cat.visionBuilders": "Construtores de Visão",
    "giving.cat.rhapsody": "Rapsódia de Realidades",
    "giving.cat.lwsat": "Loveworld SAT",
    "giving.cat.interiorMissions": "Missões de Cidades do Interior",
    "giving.cat.healingSchool": "Escola de Cura",
    "giving.cat.cellMandate": "Mandato de Célula",
    "giving.cat.childrenRhapsody": "Rapsódias das Crianças",
    "giving.cat.localProjects": "Projectos Locais",
    "giving.cat.other": "Outros",
  ...
  en: {
    ...
    "of.emola": "E-Mola",
    "of.bank": "Bank",
    "of.confirm.btn": "Confirm Offering / Tithe / Partnership",
    "of.confirm.cta": "After transferring, confirm here so the Finance team can verify your report.",
    "giving.eyebrow": "Confirmation",
    "giving.title": "Giving, Tithe and Partnership Report",
    "giving.section.personal": "Personal Details",
    "giving.section.contributions": "Contributions",
    "giving.section.payment": "Payment / Proof",
    "giving.field.fullName": "Full name",
    "giving.field.birthday": "Birthday",
    "giving.field.phone": "Phone",
    "giving.field.email": "Email",
    "giving.field.church": "Church",
    "giving.field.churchPlaceholder": "Select church",
    "giving.field.cellGroup": "Cell group",
    "giving.field.cell": "Cell",
    "giving.field.cellGroupPlaceholder": "Select cell group",
    "giving.field.cellPlaceholder": "Select cell",
    "giving.field.noCells": "No cells registered under this group.",
    "giving.field.otherDesc": "Specify the categories and amounts for other donations",
    "giving.field.paymentMethod": "Payment method",
    "giving.field.methodPlaceholder": "Select",
    "giving.field.reference": "Transaction reference",
    "giving.field.transferDate": "Transfer date",
    "giving.field.pop": "Attach proof of payment / POP",
    "giving.field.fileHint": "JPG, PNG, WEBP or PDF — max 5 MB",
    "giving.field.transferMessage": "Paste M-Pesa / E-Mola / mobile money transfer message",
    "giving.field.notes": "Notes",
    "giving.total": "Grand Total",
    "giving.cancel": "Cancel",
    "giving.submit": "Submit Report",
    "giving.success": "Thank you. Your giving report was submitted successfully and will be pending verification by the Finance team.",
    "giving.error.name": "Please enter your full name.",
    "giving.error.phone": "Please enter your phone number.",
    "giving.error.church": "Please select a church.",
    "giving.error.amount": "Enter at least one amount greater than zero.",
    "giving.error.method": "Please select a payment method.",
    "giving.error.date": "Please enter the transfer date.",
    "giving.error.proof": "Attach proof of payment or paste the transfer message.",
    "giving.error.fileType": "File type not allowed. Use an image or PDF.",
    "giving.error.fileSize": "File is too large. Maximum 5 MB.",
    "giving.error.otherDesc": "Describe other donations when the Other amount is greater than zero.",
    "giving.error.spam": "Unable to submit the form.",
    "giving.error.generic": "An error occurred while submitting. Please try again.",
    "giving.cat.tithe": "Tithe",
    "giving.cat.visionBuilders": "Vision Builders",
    "giving.cat.rhapsody": "Rhapsody of Realities",
    "giving.cat.lwsat": "Loveworld SAT",
    "giving.cat.interiorMissions": "Interior City Missions",
    "giving.cat.healingSchool": "Healing School",
    "giving.cat.cellMandate": "Cell Mandate",
    "giving.cat.childrenRhapsody": "Children's Rhapsodies",
    "giving.cat.localProjects": "Local Projects",
    "giving.cat.other": "Other",
